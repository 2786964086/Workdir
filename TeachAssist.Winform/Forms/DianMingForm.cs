...
namespace TeachAssist.Winform.Forms
{
    public partial class DianMingForm : BaseForm
    {
        ...
        void CallCurrent(Button button = null)
        {
            ...
            #region 多音字
            //方法一：
            //Student stu=button.Tag as Student;
            //if (stu.Pinyin != null)
            //{
            //    CommonUtils.Speak(stu.Pinyin);
            //}
            //else
            //{
            ...
            var isn = string.IsNullOrWhiteSpace(stu.Duyin) ? stu.Name : stu.Duyin;
            CommonUtils.Speak(isn); 
            #endregion
        ...
        void MarkAsCurrent(Button button)
        {
            ...
            var avatar = $"{SysParams.AvatarDir}\\{student.Name}.jpg";
